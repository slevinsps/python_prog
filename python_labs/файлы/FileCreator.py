                ...
                if b == 0:
                    ...
                    while True:
                        ...
                        if  st1[0] == s:
                            ...
                            file2 = open('filter_name.txt', 'a+')
                            file2.write('{:<15}{:^15}{:>15}\n'.format(st1[0],st1[1],st1[2]))
                            file2.close()
                    print('Рзультаты сохранены в файле filter_name.txt')
                    file.close()
                elif b == 2:
                    ...
                    while True:
                        ...
                        if st1[1] == s:
                            # создаем файл, в который запишутся результаты
                            file2 = open('filter_year.txt', 'a+')
                            file2.write('{:<15}{:^15}{:>15}\n'.format(st1[0], st1[1], st1[2]))
                            file2.close()
                    print('Рзультаты сохранены в файле filter_year.txt')
                    file.close()
                elif b == 3:
                    ...
                    while True:
                        ...
                        if st1[2] == s:
                            # создаем файл, в который запишутся результаты
                            file2 = open('filter_price.txt', 'a+')
                            file2.write('{:<15}{:^15}{:>15}\n'.format(st1[0], st1[1], st1[2]))
                            file2.close()
                    print('Рзультаты сохранены в файле filter_price.txt')
                    file.close()
